...
# 06.10.2022
# 
# Many thanks to https://github.com/ners
# for his liberal contribution to this project
  ...
  outputs = inputs: inputs.flake-utils.lib.eachDefaultSystem (system:
    let
      ...
      build = pkgs.stdenvNoCC.mkDerivation {
        ...
        # Sources
        srcs = [
          ./QuartusCLI.qpf # Quartus project file
          ./QuartusCLI.qsf # Quartus settings file
